...
import id.bpdlh.fdb.core.databinding.FdbSevenStepperBinding

class FdbSevenStepper(context: Context, attributeSet: AttributeSet) :
    FrameLayout(context, attributeSet) {
    private var binding: FdbSevenStepperBinding? = null
    private val typedArray: TypedArray =
        context.obtainStyledAttributes(attributeSet, R.styleable.FdbStepper, 0, 0)

    init {
        binding =
            FdbSevenStepperBinding.inflate(LayoutInflater.from(context), this, true)
        setDescription(
    ...
    fun setStep(step: Int) {
        binding?.run {
            tvStep.text = context.getString(R.string.text_stepper_seven_step, step.toString())
            when (step) {
                1 -> {
                    ...
                    ivStepSix.setImageResource(R.drawable.ic_step_disabled)
                    ivStepSeven.setImageResource(R.drawable.ic_step_disabled)
                    ...
                    viewProgressFive.setBackgroundColor(
                        ContextCompat.getColor(
                            context,
                            R.color.gray_200
                        )
                    )
                    viewProgressSix.setBackgroundColor(
                        ContextCompat.getColor(
                            context,
                            R.color.gray_200
                        )
                ...
                6 -> {
                    ...
                    ivStepFour.setImageResource(R.drawable.ic_step_active)
                    ivStepFive.setImageResource(R.drawable.ic_step_active)
                    ivStepSix.setImageResource(R.drawable.ic_step_active)
                    ivStepSeven.setImageResource(R.drawable.ic_step_disabled)
                    viewProgressOne.setBackgroundColor(
                        ContextCompat.getColor(
                            context,
                ...
                7 -> {
                    ...
                    ivStepFive.setImageResource(R.drawable.ic_step_active)
                    ivStepSix.setImageResource(R.drawable.ic_step_active)
                    ivStepSeven.setImageResource(R.drawable.ic_step_active)
                    viewProgressOne.setBackgroundColor(
                        ContextCompat.getColor(
                            context,
                            R.color.primary_main_color_600
